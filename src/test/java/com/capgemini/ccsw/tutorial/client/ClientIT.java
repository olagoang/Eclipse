...
public class ClientIT {
    ...
    public static final String MODIFY_CLIENT_NAME = "Paco";

    @Test
    public void modifyWithExistIdAndDifferentNameShouldModifyClient() {
        ...
        clientSearch = response.getBody().stream().filter(item -> item.getName().equals(MODIFY_CLIENT_NAME)).findFirst()
                .orElse(null);
